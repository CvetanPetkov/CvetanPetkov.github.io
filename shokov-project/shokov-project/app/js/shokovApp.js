...
ngApp.controller('mainCtrl', ['$scope', '$rootScope', function ($scope, $rootScope) {
    ...
    $scope.setCategorySelected = function (newCategory) {
        $rootScope.categorySelected = newCategory;
    };
}]);
...
ngApp.controller('furnitureCtrl', ['$rootScope', '$scope', '$http', 'Carousel', function ($rootScope, $scope, $http, Carousel) {

    $scope.photos = [];
    $scope.Carousel = Carousel;

    $scope.getKitchens = (function () {
        let category = $rootScope.categorySelected;
        let hostUrl = 'https://baas.kinvey.com';
        let appKey = 'kid_rkRuoFBsg';
        let username = 'user';
        let password = 'user';
